    ...
    <header className="sticky top-0 z-40 w-full border-b-[4px] border-[#0F172A] bg-white">
      <div className="max-w-[1400px] w-full mx-auto px-4 md:px-6 py-3 xl:h-20 xl:py-0 flex items-center justify-between relative">
        ...
        <Link href="/" className="flex items-center gap-3 group shrink-0">
          <div className="border-[4px] border-[#0F172A] shadow-[4px_4px_0px_0px_#0F172A] transition-transform group-hover:-rotate-2 group-hover:scale-105 overflow-hidden flex items-center justify-center bg-[#FFB800]">
            <img
              src="/logo.png"
              alt="A-Eye Logo"
        ...
        >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={`text-base xl:text-sm font-sans font-bold ${isActive ? "block" : "block xl:hidden"}`}
                      >
                        {item.label}
                      </span>
                    </div>
          ...
          >
            ...
            <span className="grid items-center text-center">
              <span className="col-start-1 row-start-1 group-hover:opacity-0 transition-opacity whitespace-nowrap">
                Home
              </span>
              <span className="col-start-1 row-start-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap text-white">
                Abort
              </span>
            </span>
          </BrutalButton>
        ...
        {isConfirmTerminate && (
          ...
          >
            ...
            <div className="mt-4 mb-6">
              <h3 className="font-heading font-black text-3xl md:text-4xl uppercase text-[#0F172A] mb-3 tracking-tight">
                Terminate Session?
              </h3>
            ...
            <p className="font-sans font-bold text-[#0F172A]/80 text-base md:text-lg leading-relaxed mb-8 bg-white p-4 md:p-5 border-[3px] border-[#0F172A] shadow-[4px_4px_0px_0px_rgba(15,23,42,0.1)] relative">
              ...
              <span className="text-[#FF3366] font-black uppercase underline decoration-2 underline-offset-4">
                ALL progress
              </span>
              , including your pre-quiz and previous missions, will be{" "}
