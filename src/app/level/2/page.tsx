...
const tutorialDialogs = [
  ...
  "Just like before, select your strongest piece of evidence.",
...
export default function Level2Page() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      const isOverHand =
        magnifier.xPercent > 45 &&
        magnifier.xPercent < 80 &&
    ...
    if (tutorialStep === 7 && showVerdictModal) {
      setTutorialStep(8);
    }
    if (tutorialStep === 8 && selectedEvidenceId) {
      setTutorialStep(9);
    }
  }, [
    tutorialStep,
              ...
              {foundClues.length === 0 && foundDecoys.length === 0 ? (
                <div className="h-full absolute inset-0 flex flex-col items-center justify-center text-[#0F172A]/40 space-y-3 p-6 text-center">
                  ...
                  <p className="text-xs opacity-70 font-sans">
                    Use the magnifier to inspect the photo.
                  </p>
                </div>
              ) : (
                <AnimatePresence>
              ...
              <AnimatePresence mode="wait">
                <motion.img
                  ...
                  initial={{
                    rotateY: 90,
                    opacity: 0,
                    scaleX: [7, 8, 9].includes(tutorialStep) ? -1 : 1,
                  }}
                  animate={{
                    rotateY: 0,
                    opacity: 1,
            ...
            >
              ...
              <div className="flex justify-between items-center border-t-[3px] border-dashed border-[#0F172A]/20 pt-3">
                ...
                <Button
                  ...
                  disabled={
                    tutorialCooldown > 0 ||
                    [3, 4, 5, 7, 8, 9].includes(tutorialStep)
                  }
