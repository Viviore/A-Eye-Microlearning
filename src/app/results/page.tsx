...
export default function ResultsDashboardPage() {
  ...
  const getCasePercentage = (score: number) =>
    Math.round((score / maxCaseScore) * 100);
  ...
  let calibrationDesc =
    "Complete your case reports to establish a full calibration profile.";
  ...
  return (
    <main className="min-h-[100dvh] bg-[#FAFAFA] text-[#0F172A] p-4 sm:p-6 md:p-12 relative font-sans pb-32 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-opacity-20">
      <motion.div
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-[4px] border-[#0F172A] pb-8"
        >
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black font-heading tracking-widest uppercase text-[#0F172A] drop-shadow-[4px_4px_0_rgba(255,184,0,1)]">
                LEARNING DEBRIEF
              </h1>
            </div>
            <p className="text-[#0F172A] font-bold font-mono text-xs sm:text-sm tracking-widest uppercase bg-white border-2 border-[#0F172A] inline-block px-3 py-1 shadow-[2px_2px_0px_0px_#0F172A]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mt-12 md:mt-16">
          ...
          >
            <div className="flex-1 bg-white border-[4px] border-[#0F172A] p-8 pb-12 shadow-[8px_8px_0px_0px_#0F172A] relative flex flex-col items-center justify-center text-center">
              ...
              <div className="mt-8 w-full bg-[#FAFAFA] border-[3px] border-[#0F172A] py-8 relative shadow-[inset_4px_4px_0px_rgba(15,23,42,0.05)]">
                <span className="text-6xl sm:text-7xl lg:text-8xl font-black font-mono text-[#0F172A] tracking-tighter">
            ...
            <div className="bg-white border-[4px] border-[#0F172A] p-6 shadow-[8px_8px_0px_0px_#0F172A] relative shrink-0">
              ...
              <div className="flex items-center gap-4">
                <div className="text-5xl font-black font-heading text-[#0F172A]">
                  {accuracyPercent}%
                </div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-7 flex">
            <div
              className={`w-full border-[4px] border-[#0F172A] p-6 lg:p-10 shadow-[8px_8px_0px_0px_#0F172A] flex flex-col relative overflow-hidden ${profileColor}`}
            >
              <div
              ...
              <div className="relative z-10 flex items-center justify-between border-b-[4px] border-[#0F172A] pb-4 mb-auto bg-white/40 px-4 py-2 border-t-[4px] -mx-6 -mt-6 lg:-mx-10 lg:-mt-10">
                <div className="font-black font-heading uppercase tracking-widest text-[#0F172A] text-lg lg:text-xl flex items-center gap-2">
                  <Target className="w-6 h-6" strokeWidth={2.5} /> PROFICIENCY
                  PROFILE
                </div>
              ...
              <div className="relative z-10 text-center space-y-8 mt-12 mb-8">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black font-heading uppercase tracking-widest text-white drop-shadow-[4px_4px_0_rgba(15,23,42,1)] py-4">
                  {calibrationProfile}
                </h2>
                  ...
                  <div className="p-6 lg:p-8 bg-[#FAFAFA] flex flex-col gap-6">
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div className="flex-1">
                        <div className="text-xs font-bold font-mono text-[#0F172A]/70 uppercase mb-1">
                          PRIMARY TRAIT
                        </div>
                        <div className="text-lg lg:text-xl font-black font-heading text-[#0F172A] uppercase leading-tight">
                          {cognitivePrimary}
                        </div>
                      </div>
                    </div>
        ...
        <motion.div variants={itemVariants} className="pt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
            {/* Case 001 Card */}
            <div
              className={`p-6 pt-8 border-[4px] border-[#0F172A] shadow-[6px_6px_0px_0px_#0F172A] bg-white relative group hover:-translate-y-2 hover:shadow-[10px_10px_0px_0px_#0F172A] transition-all duration-300 flex flex-col justify-between`}
            >
              ...
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="text-xs font-bold font-mono text-[#0F172A]/70 uppercase tracking-widest">
                    CASE 001
                  </div>
                </div>
                <div className="text-2xl font-black font-heading uppercase leading-tight">
                  TEXT
                  <br />
                  ANALYSIS
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ALL_PROFILES.map((profile, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`border-[4px] border-[#0F172A] p-6 shadow-[6px_6px_0px_0px_#0F172A] flex flex-col relative transition-all duration-300 ${isCurrent ? `${profile.color} -translate-y-2 shadow-[10px_10px_0px_0px_#0F172A] z-10` : "bg-white hover:-translate-y-1"}`}
                >
                  {isCurrent && (
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div
                      className={`p-3 border-[3px] border-[#0F172A] shadow-[4px_4px_0px_0px_#0F172A] ${isCurrent ? "bg-white" : profile.color}`}
                    >
                      <Icon
                  ...
                  <h3
                    className={`text-xl font-black font-heading uppercase leading-tight mb-3 ${isCurrent ? "text-white drop-shadow-[2px_2px_0_rgba(15,23,42,1)]" : "text-[#0F172A]"}`}
                  >
                    {profile.name}
                  </h3>
                  <p
                    className={`text-sm font-bold font-sans flex-1 mb-6 ${isCurrent ? "text-[#0F172A]" : "text-[#0F172A]/70"}`}
                  >
                    {profile.desc}
                  </p>

                  <div
                    className={`mt-auto p-4 border-[3px] border-[#0F172A] ${isCurrent ? "bg-white" : "bg-[#FAFAFA]"}`}
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <div className="text-[10px] font-bold font-mono text-[#0F172A]/70 uppercase leading-none mb-0.5">
                            Primary Trait
                          </div>
                          <div className="text-sm font-black font-heading text-[#0F172A] uppercase leading-tight">
                            {profile.cognitivePrimary}
                          </div>
                        </div>
                      </div>
              ...
              <div className="mt-6 flex flex-col items-center">
                <div className="flex items-center justify-between w-full mb-6">
                  <div className="flex flex-col items-center">
                    <span className="text-4xl font-black font-heading text-[#0F172A]">
                      {preSkill}%
                    </span>
                    <span className="font-mono text-xs font-bold text-[#0F172A]/70 uppercase tracking-widest">
                      Before
                    </span>
                  </div>
                  <ChevronRight
                    className="w-8 h-8 text-[#0F172A]/30"
                    strokeWidth={3}
                  />
                  <div className="flex flex-col items-center">
                    <span className="text-4xl font-black font-heading text-[#FFB800] drop-shadow-[2px_2px_0_#0F172A]">
                      {postSkill}%
                    </span>
                    <span className="font-mono text-xs font-bold text-[#0F172A]/70 uppercase tracking-widest">
                      After
                ...
                <div className="bg-[#FFB800] border-[3px] border-[#0F172A] px-2 sm:px-4 py-2 shadow-[4px_4px_0px_0px_#0F172A] w-full text-center">
                  <span className="font-heading font-black text-lg md:text-xl text-[#0F172A] uppercase">
                    {skillGrowthSign}
                    {skillGrowth} percentage points
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white border-[4px] border-[#0F172A] p-6 shadow-[6px_6px_0px_0px_#0F172A] flex flex-col justify-between flex-1">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl font-black font-heading text-[#0F172A]">
                      {preAwareness}/5
                    </span>
                    <ChevronRight
                      className="w-5 h-5 text-[#0F172A]/30"
                      strokeWidth={3}
                    />
                    <span className="text-2xl font-black font-heading text-[#FFB800] drop-shadow-[1px_1px_0_#0F172A]">
                      {postAwareness}/5
                    </span>
                  </div>
      ...
      >
        ...
        {/* Main Card */}
        <div
          className={`flex-1 border-[8px] border-[#0F172A] p-10 shadow-[16px_16px_0px_0px_#0F172A] flex flex-col relative overflow-hidden ${profileColor}`}
        >
          <div
            className="absolute inset-0 opacity-10"
            style={{
              backgroundImage:
                "radial-gradient(circle at 4px 4px, #0F172A 2px, transparent 0)",
            ...
            <div className="bg-white border-[6px] border-[#0F172A] shadow-[12px_12px_0px_0px_#0F172A] text-left relative flex flex-col mx-auto w-full max-w-3xl">
              ...
              <div className="p-8 bg-[#FAFAFA] flex flex-col gap-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    <div className="text-base font-bold font-mono text-[#0F172A]/70 uppercase mb-1">
                      PRIMARY TRAIT
                    </div>
                    <div className="text-2xl font-black font-heading text-[#0F172A] uppercase leading-tight">
                      {cognitivePrimary}
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-8 flex justify-between items-end w-full">
          <div className="flex flex-col gap-2">
            ...
            <div className="px-6 py-3 bg-[#0F172A] text-white font-bold font-mono text-3xl border-[4px] border-[#0F172A] shadow-[4px_4px_0px_0px_#FFB800]">
              {cumulativeScore.toString().padStart(4, "0")}{" "}
              <span className="text-[#FFB800] text-xl">/ {maxTotalScore}</span>
            </div>
          </div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0F172A]/80 backdrop-blur-sm">
            ...
            >
              <div
                ref={modalRef}
                className="relative w-full bg-white border-[4px] border-[#0F172A] p-8 shadow-[12px_12px_0px_0px_rgba(255,184,0,1)]"
              >
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="hide-on-export absolute top-4 right-4 text-[#0F172A] hover:text-red-500 transition-colors cursor-pointer"
                >
                  <XCircle className="w-8 h-8" strokeWidth={2.5} />
                </button>

                <div className="flex items-center gap-4 mb-8 border-b-[4px] border-[#0F172A] pb-4">
                  <h2 className="text-3xl font-black font-heading uppercase text-[#0F172A]">
                    Result Summary
                  </h2>
                </div>
                ...
                <div className="space-y-4 font-mono text-[#0F172A]">
                  <div>
                    <h3 className="font-bold text-xs text-[#0F172A]/60 uppercase tracking-widest mb-1">
                      Your Profile
                    </h3>
                    <div
                      className={`p-3 border-[3px] border-[#0F172A] ${profileColor} font-black text-xl flex items-center gap-3 shadow-[4px_4px_0px_0px_#0F172A]`}
                    >
                  ...
                  <div className="bg-[#FAFAFA] border-[3px] border-[#0F172A] p-4 text-center relative shadow-[4px_4px_0px_0px_#0F172A] mt-2">
                    <div className="text-xs font-bold text-[#0F172A]/60 uppercase tracking-widest mb-1">
                      Overall Accuracy
                    </div>
                ...
                <div className="hide-on-export mt-8 flex gap-4">
                  <BrutalButton
                  ...
                  >
                    ...
                    {isDownloading ? "EXPORTING..." : "EXPORT RESULT"}
                  </BrutalButton>
                </div>
              </div>
            </motion.div>
