    ...
    <>
      ...
      <main className="min-h-screen relative overflow-x-hidden font-sans flex flex-col bg-[#FAFAFA] pt-20">
        ...
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          ...
          <div
            className="absolute top-[15%] right-[8%] w-64 h-64 border-[3px] border-[#0F172A]/[0.04] animate-[spin_45s_linear_infinite] hidden lg:block"
          />
          {/* Small fast-spinning diamond */}
          <div
            className="absolute bottom-[20%] left-[12%] w-32 h-32 border-[3px] border-[#FFB800]/[0.08] rotate-45 animate-[spin_25s_linear_infinite_reverse] hidden md:block"
          />
          {/* Medium pulsing circle */}
          <div
            className="absolute top-[60%] right-[15%] w-48 h-48 rounded-full border-[2px] border-[#0F172A]/[0.04] animate-[pulse_8s_ease-in-out_infinite] hidden lg:block"
          />
          {/* Tiny accent dot top-left */}
          <div
            className="absolute top-[30%] left-[5%] w-4 h-4 bg-[#FFB800]/[0.15] animate-[pulse_4s_ease-in-out_infinite] hidden md:block"
          />
          {/* Tiny accent dot bottom-right */}
          <div
            className="absolute bottom-[35%] right-[5%] w-3 h-3 bg-[#0F172A]/[0.08] animate-[pulse_6s_ease-in-out_infinite_1s] hidden md:block"
          />
          {/* Large dashed circle */}
          <div
            className="absolute top-[10%] left-[60%] w-96 h-96 rounded-full border-[2px] border-dashed border-[#0F172A]/[0.03] animate-[spin_60s_linear_infinite] hidden xl:block"
          />
          {/* Cross-hair markers */}
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(#FFB800 1.5px, transparent 1.5px)",
